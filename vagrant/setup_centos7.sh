...
# configure selinux
echo -e "${BULLET} Configuring selinux..."
...
All project sources are mapped in /usr/src/libzbxpgsql
...
[[ -L /usr/lib64/modules/libzbxpgsql.so ]] || ln -s /usr/src/libzbxpgsql/src/.libs/libzbxpgsql.so /usr/lib64/modules/libzbxpgsql.so

# for v3+
mkdir -p /usr/lib64/zabbix/modules
[[ -L /usr/lib64/zabbix/modules/libzbxpgsql.so ]] || ln -s /usr/src/libzbxpgsql/src/.libs/libzbxpgsql.so /usr/lib64/zabbix/modules/libzbxpgsql.so
